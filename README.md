### Lab07 - Регистрация и поиск сервиса в реестре jUDDI
- [x] Требуется разработать приложение, осуществляющее регистрацию сервиса в реестре jUDDI
- [x] а также поиск сервиса в реестре и обращение к нему
- [x] Рекомендуется реализовать консольное приложение, которое обрабатывает 2 команды
  - [x] Итог работы первой команды - регистрация сервиса в реестре 
  - [x] вторая команда должна осуществлять поиск сервиса, а также обращение к нему.
